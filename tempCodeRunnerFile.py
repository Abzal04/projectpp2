...
# Win Screen
win_font = pg.font.SysFont("comicsansms",50)
win_font_text = win_font.render("Congratulations,\n You saved Macbook!!!",True,(255,255,255))
...
end_time = start_time.replace(minute=14,second=1)
